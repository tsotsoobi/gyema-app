...
export function ListingDetailSheet({
  ...
  const shareText =
    listing.kind === "package"
      ? `Sender needs a delivery: ${listing.fromCity} → ${listing.toCity}${shareDate ? ` on ${shareDate},` : ""} on Gyema (${price} π). #PiTestnet transaction. Open in Pi Browser to accept:`
      : `Traveller heading ${listing.fromCity} → ${listing.toCity}${shareDate ? ` on ${shareDate},` : ""} on Gyema, carrying for ${price} π. #PiTestnet transaction. Open in Pi Browser to offer your parcel:`

...
export function ListingDetailSheet({
  ...
  const shareText =
    listing.kind === "package"
      ? `Sender needs a delivery: ${listing.fromCity} → ${listing.toCity} on Gyema (${price} π). #PiTestnet transaction. Open in Pi Browser to accept:`
      : `Traveller heading ${listing.fromCity} → ${listing.toCity} on Gyema, carrying for ${price} π. #PiTestnet transaction. Open in Pi Browser to offer your parcel:`
